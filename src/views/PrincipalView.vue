<template>
    <div>
        ...
        <div class="flex justify-center gap-4 mt-6">
            <button @click="previousPage" class="btn bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 disabled:opacity-50" :disabled="offset === 0">Anterior</button>
            <button @click="nextPage" class="btn bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Próximo</button>
        </div>
    </div>
</template>
<script setup>
